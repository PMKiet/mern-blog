...
import { HiChatBubbleBottomCenterText, HiDocumentText } from "react-icons/hi2"
            ...
            <div className="flex-wrap flex gap-4 justify-center">
                <div className="flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md">
                    ...
                    <div className="flex gap-2 text-sm">
                        <span className="text-green-500 flex items-cover">
                            <HiArrowNarrowUp />
                            {lastMonthUsers}
                        </span>
                ...
                <div className="flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md">
                    <div className="flex justify-between">
                        ...
                        <HiChatBubbleBottomCenterText className="bg-indigo-500 text-white rounded-full text-5xl p-3 shadow-lg" />
                    </div>
                    <div className="flex gap-2 text-sm">
                        <span className="text-green-500 flex items-cover">
                            <HiArrowNarrowUp />
                            ...
                            <Table.Body key={comment._id} className="divide-y">
                                <Table.Row >
                                    <Table.Cell className="w-96">
                                        <p className="line-camp-2">{comment.content}</p>
                                    </Table.Cell>
